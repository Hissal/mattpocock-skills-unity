...
- Whether Hub project templates include `com.unity.test-framework` in the manifest.
- Behaviour of runtime `YieldInstruction`s (e.g. `WaitForSeconds`) inside Edit mode `[UnityTest]`.
- `Awaitable` as a test return type.

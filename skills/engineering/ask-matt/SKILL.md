...
- **`/unity-code-lifecycle`**: adding a static, a singleton or a static event, writing code that runs on load or on entering Play mode, or a bug that shows up only on the second Play.

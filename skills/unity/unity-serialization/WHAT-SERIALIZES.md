...
- A missing type loads as null, and re-saving the host drops its data (the rename rules and the validation checklist in `SKILL.md` cover the fix and the check).
